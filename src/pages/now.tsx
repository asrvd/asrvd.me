    ...
    <Layout>
      <div className="w-full min-h-full h-full p-8 flex flex-col">
        <section className="flex flex-col w-full justify-between gap-6 mt-16 lg:mt-0 md:mt-0 prose">
          ...
          />
          <p className="text-zinc-400 text-[0.6rem]">Last Updated <span className="text-zinc-300 underline decoration-dotted underline-offset-4 text-[0.6rem]">{props.metadata.publish_date}</span></p>
        </section>
      </div>
    </Layout>
  );
